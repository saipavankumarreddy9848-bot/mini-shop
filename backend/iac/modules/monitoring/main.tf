...
# ---------------------------------------------------------------------------
# SNS topic - alarms publish here, optionally emailing you
# ---------------------------------------------------------------------------
...
resource "aws_cloudwatch_metric_alarm" "high_cpu" {
  ...
  statistic           = "Average"
  threshold           = 80
  alarm_description   = "ECS service CPU utilization above 80% for 2 minutes"
...
resource "aws_cloudwatch_metric_alarm" "high_5xx" {
  ...
  statistic           = "Sum"
  threshold           = 5
  alarm_description   = "More than 5 server errors (5xx) in 1 minute"
  alarm_actions       = [aws_sns_topic.alerts.arn]
...
resource "aws_cloudwatch_metric_alarm" "high_latency" {
  ...
  threshold           = 2 # seconds
  alarm_description   = "p99 response time above 2s for 3 minutes"
  alarm_actions       = [aws_sns_topic.alerts.arn]
  treat_missing_data  = "notBreaching"
...
# ---------------------------------------------------------------------------
# Dashboard - single-pane view of the app's health
# ---------------------------------------------------------------------------
