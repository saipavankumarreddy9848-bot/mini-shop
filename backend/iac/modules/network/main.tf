...
# ---------------------------------------------------------------------------
# Internet Gateway - allows public subnets (ALB, etc.) to reach the internet
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Public subnets - one per AZ. Hosts the ALB and NAT Gateway(s).
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Private subnets - one per AZ. Hosts ECS tasks and RDS - no direct
# internet access, only outbound via NAT Gateway.
# ---------------------------------------------------------------------------
...
# (e.g. ECS tasks pulling images, hitting external APIs) without being
...
# ECS task SG - only accepts traffic from the ALB, on the app port
...
# RDS SG - only accepts traffic from ECS tasks, on the Postgres port
